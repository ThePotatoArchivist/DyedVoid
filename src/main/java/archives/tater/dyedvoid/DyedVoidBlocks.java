...
public class DyedVoidBlocks {
    ...
    private static Block register(Identifier identifier, Function<AbstractBlock.Settings, Block> block, AbstractBlock.Settings settings) {
    ...
    private static Block register(String path, Function<AbstractBlock.Settings, Block> block, AbstractBlock.Settings settings) {
